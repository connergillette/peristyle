  ...
  return (
    <div className="container mx-auto w-screen h-screen">
      <div className="flex flex-col h-screen items-center content-center justify-center align-center gap-10 w-full">
        ...
        <div className="flex flex-col align-center align-middle justify-center text-center h-64">
          <h1 className="font-['Bely_Display'] text-[150px] leading-[150px] text-center">2023</h1>

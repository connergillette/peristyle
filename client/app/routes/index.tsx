    ...
    <div className={`w-screen h-screen transition-colors duration-1000 overflow-x-hidden`}>
      <div className={`container mx-auto flex flex-row h-screen`}>
        ...
        <div className="flex flex-col w-[60%] h-screen items-center content-center justify-center align-center gap-10 ml-auto">
          ...
          <div className="flex flex-col gap-3 snap-y snap-mandatory ml-auto w-10/12 pb-[400px] pt-[100%]">
            ...
            <ProjectTile month="APR" bg="bg-[#73AFAF]" text="text-[#73AFAF]" projectName="RYLAI" progress={15} />
            <ProjectTile month="MAY" bg="bg-[#3F9292]" text="text-[#3F9292]" projectName="APPARITION" progress={75} />

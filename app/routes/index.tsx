...
export default function Index() {
  ...
  return (
    <div className={`w-screen h-screen container mx-auto max-xl:overflow-y-hidden`}>
      <div className={`mx-auto h-screen flex flex-col overflow-y-hidden`}>
        ...
        <div className="relative max-xl:top-56 max-xl:overflow-x-hidden w-full h-full max-xl:h-max overflow-y-hidden">

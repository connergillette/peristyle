...
export default function ImageBlock ({ src, alt, color }: Props) {
  return (
    <div className={`self-right rounded-lg bg-white aspect-square border-solid border-2 object-cover overflow-hidden ${color ? color.border : themeColors.GRAY.border}`}>
